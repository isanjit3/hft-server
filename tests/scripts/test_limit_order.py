...
# Initialize Alice with money and no assets
alice = initialize_user("alice", "password123", 10000.0, {})
print("Initialized Alice\n")

# Initialize Bob with assets and no money
assets_bob = {
    "ABC": {
        "symbol": "ABC",
        "shares": 100,
...
# Initialize Charlie with assets and no money
assets_charlie = {
    "ABC": {
        "symbol": "ABC",
        "shares": 100,
...
print(json.dumps(portfolio_alice_before, indent=4))
print("\n")
...
print(json.dumps(portfolio_bob_before, indent=4))
print("\n")
...
print(json.dumps(portfolio_charlie_before, indent=4))
print("\n")

# Alice places a limit buy order for ABC
buy_order_alice = place_buy_order(token_alice, "ABC", 100, 50, "Limit")
print("Alice's Buy Order Response:")
print(json.dumps(buy_order_alice, indent=4))
print("\n")

# Bob places a sell order for ABC at $55 (higher than Alice's limit price, so it won't be filled)
sell_order_bob = place_sell_order(token_bob, "ABC", 100, 55, "Limit")
print("Bob's Sell Order Response:")
print(json.dumps(sell_order_bob, indent=4))
print("\n")

# Charlie places a sell order for ABC at $50 (matches Alice's limit price exactly)
sell_order_charlie = place_sell_order(token_charlie, "ABC", 100, 50, "Limit")
print("Charlie's Sell Order Response:")
print(json.dumps(sell_order_charlie, indent=4))
print("\n")
...
print(json.dumps(portfolio_alice_after, indent=4))
print("\n")
...
print(json.dumps(portfolio_bob_after, indent=4))
print("\n")
...
print(json.dumps(portfolio_charlie_after, indent=4))
print("\n")
...
expected_bob_money = 0.0

expected_charlie_assets = {}
expected_charlie_money = 5000.0
